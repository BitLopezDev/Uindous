...
window.onload=function(){
	location.href="../1026/Nosesion.php";
...
"><h1>/!\/!\/!\Atención: usted no ha inicado sesión./!\/!\/!\ </h1><br><h2>Inicie sesión para poder acceder a todas las funcionalidades del sistema.</h2><br><br> <button onClick="location.href='../apagado/bloqueo.php'">Aceptar</button></center>
