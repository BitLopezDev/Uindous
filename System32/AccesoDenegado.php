...
window.onload=function(){
	location.href="../1026/AccesoDenegado.php";
	setTimeout(function(){
...
"><h1>/!\/!\Acceso denegado./!\/!\</h1><br><h2>El archivo al que intenta acceder está protegido por el sistema por lo que su visualización es imposible.<br><br> <button onClick="location.href='../uindous.php'">Aceptar</button></center>
