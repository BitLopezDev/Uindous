...
<div id="superior"><h3><img src="../../../Documents_and_settings/visible/Windows10/carpetaatras.ico" onclick="location.href='../';" id="atras" height="30px" width="30px"></h3><div id="cierre"></div><div id="logo"><center><img src="../../../Documents_and_settings/visible/logo.ico" /></center></div></div>
</header>
...
$(document).ready(function(){
    if (top != self) {$("#atras").hide();
$("html").addClass("fondodefecto");
$("#audio").removeClass("fondoclaro");
$("header").hide();
