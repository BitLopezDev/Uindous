...
while($archivo = readdir($directorio) )
    {   
         if( $archivo!="." && $archivo !=".."  && file_exists("../part/".$archivo."/BitLocker/btlckr.php") && file_exists("../part/".$archivo."/index.php") )
        {
    echo "<li class='fondoobscuro protegido' ><div data-location='../part/".$archivo."' ><img width=40px' height=40px' src='../part/".$archivo."/index.ico'><br>".$archivo."<br></div></li>";
...
while($archivo =readdir($directorio) )
    {   
      ...
      /*&& $archivo !="index.php" && $archivo !="SYSREG_SystDir.true"*/
         if( $archivo!="." && $archivo !=".."  && (file_exists("../part/".$archivo."/BitLocker/btlckr.php")==false) && file_exists("../part/".$archivo."/index.php") )
        {
